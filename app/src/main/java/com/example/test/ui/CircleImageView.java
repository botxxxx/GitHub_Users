...
public class CircleImageView extends AppCompatImageView {
    ...
    public void setBorderColorResource(@ColorRes int borderColorRes) {
        this.mBorderColor = ContextCompat.getColor(getContext(), borderColorRes);
    }

    public void setCircleBackgroundColorResource(@ColorRes int circleBackgroundRes) {
        mCircleBackgroundColor = ContextCompat.getColor(getContext(), circleBackgroundRes);
    }
    ...
    private void initializeBitmap() {
        mBitmap = isDisableCircularTransformation ? null : getBitmapFromDrawable(getDrawable());
        setup();
    }
